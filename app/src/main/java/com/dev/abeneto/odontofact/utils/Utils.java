package com.dev.abeneto.odontofact.utils;
    ...
    public static BigDecimal calcularTotalFactura(ArrayList<LineaFactura> lineasFacturas, GastosLaboratori gastosLaboratori, BigDecimal porcentajeOrtodoncia, BigDecimal porcentajeOtros, BigDecimal descuentoTarjeta) {
        ...
        for (LineaFactura lineaFactura : lineasFacturas) {
            ...
            if (lineaFactura.getTipusPagament().getCodi().equals(TipusPagament.TARGETA.getCodi())) {
                ...
                importeProvisional = importeProvisional.multiply((BigDecimal.valueOf(100).subtract(descuentoTarjeta)).divide(BigDecimal.valueOf(100)));
        ...
        provisionalOrto = provisionalOrto.multiply(porcentajeOrtodoncia.divide(BigDecimal.valueOf(100)));
        ...
        provisionalResta = provisionalResta.multiply(porcentajeOtros.divide(BigDecimal.valueOf(100)));
